...
describe MusixClient do
  ...
  context "searching by artist name" do
    it "constructs a GET request with the artist's name" do
      ...
      musix_client.search_by_artist("Diana Ross")
  ...
  context "searching by song title" do
    it "constructs a GET request with the song title" do
      ...
      musix_client.search_by_track_title("back to december")
  ...
  context "searching by an artist and song title" do
    it "contructs a GET request with the song title and artist name" do
      ...
      musix_client.search_by_artist_and_track("taylor swift",
                                              "back to december")
